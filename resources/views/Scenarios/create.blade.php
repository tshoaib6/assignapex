...
<h1 class="page-header mb-4">
    Add Scenario <small class="text-muted">Create a new scenario</small>
</h1>

<div class="card">
    <div class="card-header">
        <h4><i class="fa fa-plus me-2"></i> New Scenario</h4>
    </div>
    ...
    <div class="card-body">
        <form action="{{ route('scenarios.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="pause" class="form-control">
            </div>

            <div class="mb-3">
                <label class="form-label">Number of Devices</label>
                <input type="number" name="number_of_devices" class="form-control">
            </div>
