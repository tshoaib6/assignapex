...
<div id="tenthForm" style="display:none; margin-top:20px;">
  <div class="card">
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <select class="form-select" id="reportValidationDecision" required>
      ...
      <div class="form-group mb-3">
        ...
        <textarea class="form-control" id="reportValidationNotes" rows="3" placeholder="Please add your notes if there is any..."></textarea>
      </div>
...
<button  type="button" class="btn btn-lime mb-1 me-2" style="width: fit-content;" onclick="proceedToEleventhForm()">Submit Tenth Form</button>
</div>
